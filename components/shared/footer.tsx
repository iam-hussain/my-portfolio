...
export function Footer() {
  ...
  return (
    <footer className="border-t border-border-subtle py-6 sm:py-8 px-4 sm:px-6 md:px-8 lg:px-12 xl:px-16">
      <div className="max-w-7xl mx-auto flex flex-col items-center gap-1.5 sm:gap-2 text-center">
